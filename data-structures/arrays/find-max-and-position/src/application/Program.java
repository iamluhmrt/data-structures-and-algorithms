...
public class Program {
    public static void main(String[] args) {
        /*
         * Problem: Find Maximum Value and Position
         *
         * Description:
         * Write a program that reads N real numbers and stores them in an array.
         * Then, display the largest value and its position in the array,
